...
function printAllRight<T>(args: T[]){ // this means the function expect you will pass an array of the T type
    console.log(args.forEach(arg => { // will work, cuz it knows that you will pass an array
        console.log(arg);
    }));
}
...
// // 2. generic types
const echo2: <T>(data: T) => T = <T>(data: T) => data;
